...
bool pin1value=digitalRead(pin1);
bool pin2value=digitalRead(pin2);
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(pin1),interup1,RISING);
  attachInterrupt(digitalPinToInterrupt(pin2),interup2,RISING);
